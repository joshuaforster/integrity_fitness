        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-sm/6 font-semibold text-white transition-colors duration-150"
            >
              {item.name}
            </a>
          ))}
        ...
        <div className="border-t border-gray-100 px-6 pb-4 space-y-1">
          {navigation.map((item) => (
            <a
              ...
              className="block rounded-lg px-3 py-2 text-base font-semibold text-white hover:bg-gray-50 transition-colors duration-150"
            >
              {item.name}
            </a>
          ))}
