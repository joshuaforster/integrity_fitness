        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border border-zinc-950 text-zinc-950 px-6 py-3.5 text-sm font-bold tracking-wide uppercase hover:bg-zinc-950 hover:text-white transition-colors duration-200 rounded-xl"
            >
              Get Directions
          ...
          >
            ...
            <div className="[backdrop-filter:blur(28px)_saturate(160%)] bg-[#18181B]/[0.12] border border-[#18181B]/[0.18] rounded-xl p-2 shadow-[0_32px_80px_rgba(0,0,0,0.22),0_8px_24px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.12)] ring-1 ring-[#18181B]/[0.07]">
              {/* Map viewport */}
