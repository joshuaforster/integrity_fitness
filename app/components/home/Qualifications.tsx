  ...
  return (
    <section className="bg-zinc-900 angle-tl pb-20 md:pb-28 pt-[132px] md:pt-[164px]">
      <SectionWrapper reveal>
        ...
        {/* CPD strip */}
        <div className="mb-16">
          <p className="text-white/50 text-xs font-bold tracking-widest uppercase mb-6 px-1">
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between">
            <div>
              <p className="text-white/50 text-xs font-bold tracking-[3px] uppercase mb-1">
