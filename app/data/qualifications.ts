...
const qualifications: Qualification[] = [
  {
    ...
    comparisonFeatures: [
      { label: "Physical Textbooks & Manual", values: [true, true, true] },
      { label: "E-Learning", values: [true, true, true] },
      { label: "Facebook Support Group", values: [true, true, true] },
      { label: "Graduate T-Shirt Upon Completion", values: [true, true, true] },
      { label: "Monthly Check In Call", values: [true, true, true] },
      { label: "Free submissions per module", values: ["1", "2", "3"] },
      { label: "1-1 support sessions per month", values: [false, "2×", "4×"] },
      { label: "Business Mentorship", values: [false, false, true] },
      { label: "Personalised Graduate T-Shirt", values: [false, false, true] },
    ],
  ...
  },
  {
    ...
    bookletPageCount: 24,
    bookletPdfPath: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/booklet-images/level-2-diploma/Level2%20Diploma.pdf",
    testimonials: [
      {
  ...
  },
  {
    ...
    pricing: [
      {
        name: "Independent",
        price: { monthly: 79.99, yearly: 799 },
        deposit: 399,
        description: "Our most cost effective option. Fully self-paced study with all course materials included.",
        includes: [
          "Graduate T-Shirt Upon Completion",
      ...
      {
        name: "Part Time",
        price: { monthly: 99.99, yearly: 899 },
        deposit: 399,
        description: "Includes our bespoke 1-1 tuition alongside flexible study.",
        includes: [
          "Graduate T-Shirt Upon Completion",
      ...
      {
        name: "Full Time",
        price: { monthly: 119.99, yearly: 999 },
        deposit: 399,
        description: "The best possible learning experience — the fastest route to qualified.",
        includes: [
          "Personalised Graduate T-Shirt Upon Completion",
    ...
    bookletPageCount: 30,
    bookletPdfPath: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/booklet-images/level-3-only/level3only.pdf",
    testimonials: [
      {
  ...
  },
  {
    ...
    heroImage: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/Duncan/20221115-IFE-CF_001.JPG",
    overview: [
    ...
    bookletPageCount: 8,
    bookletPdfPath: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/booklet-images/mental-health/mentalhealth.pdf",
  },
  {
    slug: "pre-post-natal",
    ...
    heroImage: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/Duncan/20221115-IFE-CF_012.JPG",
    overview: [
    ...
    pricing: [
      {
        name: "Independent",
        price: 249,
        description: "Full course delivery with self-paced learning and tutor support.",
        includes: [
          "E-Learning",
          "Facebook Support Group",
          "1 free submission per module",
          "1 × 1-1 support session each month",
          "Monthly Check In Call",
        ],
      },
      {
        name: "Full Time",
        price: 349,
        description: "Full course delivery with intensive 1-1 tuition and all course materials.",
        includes: [
          "Personalised Graduate T-Shirt Upon Completion",
          "Physical Textbooks & Manual",
          "E-Learning",
    ...
    bookletPageCount: 12,
    bookletPdfPath: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/booklet-images/pre-post-natal/pre_post.pdf",
  },
  {
    ...
    pricing: [
      ...
      },
      {
        name: "Full Time",
        price: 199,
        description: "Full day training with all course materials and certification.",
        includes: [
          "Graduate T-Shirt Upon Completion",
          "Physical Textbooks & Manual",
          "E-Learning",
    ...
    bookletPageCount: 17,
    bookletPdfPath: "https://pub-6e6bb53af6c34756a861d2c0a8259e84.r2.dev/booklet-images/first-aid/firstaid.pdf",
  },
];
