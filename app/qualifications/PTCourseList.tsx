      ...
      {courses.map((q) => (
        ...
        >
          <Link
            ...
            className="flex flex-col sm:flex-row sm:items-center justify-between p-6 md:p-8 bg-white border border-zinc-200/60 hover:border-zinc-400 hover:shadow-md transition-all duration-300 group rounded-sm shadow-xs outline-none focus-visible:ring-2 focus-visible:ring-[#CE1A19]"
          >
