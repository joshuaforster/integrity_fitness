        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <motion.div
              ...
              className="[backdrop-filter:blur(20px)_saturate(150%)] bg-white/[0.05] border border-white/[0.1] rounded-2xl p-8 md:p-10 flex flex-col shadow-[0_8px_40px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.08)]"
            >
