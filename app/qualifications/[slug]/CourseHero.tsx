    ...
    <section className="relative h-[70vh] min-h-[520px]  sm:min-h-[380px] flex items-end bg-zinc-950 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 pb-10 md:pb-14 pt-28 w-full">
        <motion.div variants={container} animate="visible">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight text-white uppercase tracking-tight max-w-3xl mb-3">
          ...
          <motion.p
            variants={fadeUp}
            className="text-white text-sm md:text-base max-w-xl leading-relaxed mb-8"
          >
            {qual.tagline}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <Image
                ...
                width={56}
                height={18}
                className="object-contain h-12 w-auto brightness-0 invert opacity-80"
              />
            </div>
          </motion.div>
        </motion.div>
