...
export const contactFormSection = {
  label: "Get In Touch",
  heading: "Begin Your Progression.",
  ...
  mapNote: "Our courses run at Complete Fitness Gym in Norwich, Norfolk — a professional facility purpose-built for coaching and assessment.",
